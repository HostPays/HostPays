    ...
    <nav class="bg-gray-800">
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div class="relative flex items-center justify-between h-16">
                ...
                @guest
                    <a href="{{ route('login') }}"
                        class="inline-block align-middle text-sm font-medium leading-5 text-white transition duration-150 ease-in-out hover:text-gray-300 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                        Login
                    </a>
                @else
